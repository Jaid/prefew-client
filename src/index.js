 ...
 * @example
 * import prefewClient from "prefew-client"
 * let result = prefewClient(["a", "b"])
 * result = {a: null, b: null}
 * @example
 * import prefewClient from "prefew-client"
 * let result = prefewClient(["a", "b"], "value")
 * result = {a: "value", b: "value"}
 * @example
 * import prefewClient from "prefew-client"
 * let result = prefewClient(["a", "b"], (key, index) => `value for ${key} #${index + 1}`)
 ...
 * import {parallel} from "prefew-client"
